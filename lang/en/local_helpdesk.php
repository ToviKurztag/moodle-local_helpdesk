...
$string['localname']            = 'Help Desk';
$string['helpdesk:answer']      = 'Help Desk Answerer';
$string['local/helpdesk:answer']= $string['helpdesk:answer'];
$string['answerer']             = 'Answerer';
$string['anyanswerer']          = 'Any answerer';
$string['helpdesk:ask']         = 'Help Desk Asker';
$string['local/helpdesk:ask']   = $string['helpdesk:ask'];
$string['myinstitutiontickets']            = 'My Institution Questions';
$string['helpdesk:view']        = 'View a helpdesk ticket';
$string['helpdesk:addinstance'] = 'Add a helpdesk local';
$string['helpdesk:myaddinstance'] = 'Add a helpdesk local to My Moodle';
...
$string['viewalltickets']       = 'Search on questions';
...
$string['assignedusers']        = 'Assigned Supporters';
$string['noneassigned']         = 'No supporters are assigned.';
$string['assignuser']           = 'Assign a supporter';
...
$string['institutionpreferences']    = 'institution preferences';
...
$string['newtickets']           = 'New Questions';
$string['assignedto']           = 'My Opened Questions';
 ...
 */
$string['settingsinstitution']  = 'settingsinstitution';
$string['institutions']     = 'institutions';
$string['institutionname']     = 'institutionname';
$string['institutionnamedesc']     = 'institutionnamedesc';
$string['cooperative']     = 'cooperative';
$string['enablecooperative']     = 'enable cooperative between institition users';
$string['generalsettings']      = 'General Helpdesk Settings';
$string['generalsettingsdesc']  = 'These settings affect all helpdesk plugins.';
$string['localnameconfig']      = 'local name';
$string['localnameconfigdesc']  = 'Change the local name from the default';
...
$string['getemailticketsdesc']  = 'Parses incoming emails into the current help desk plugin. This allows user to be able
                                   send emails and have it show up in the help desk local. (UNDER CONSTRUCTION)';
...
Your questions have been updated in follow link !ticketlink!.

Question details:

question number: !ticketid!
username: !client! 
...
$string['emailassignsubject']  = 'Ticket !ticketid! Assigned you';
$string['emailnewticketsubject']  = 'Ticket !ticketid! Created ';
...
$string['enablecooperative_help'] = 'This option displays ticket of all users in your institution';
