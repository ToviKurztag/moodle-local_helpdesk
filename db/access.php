...
if (!defined('HELPDESK_CAP_ASK')) {
    define('HELPDESK_CAP_ASK', 'local/helpdesk:ask');
}
if (!defined('HELPDESK_CAP_ANSWER')) {
    define('HELPDESK_CAP_ANSWER', 'local/helpdesk:answer');
}
...
$capabilities = array (
   ...
   // Add some capabilities required in 2.4, it doesn't break 2.2/2.3.
    'local/helpdesk:myaddinstance' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => array(
            'user' => CAP_ALLOW
    ...
    'local/helpdesk:addinstance' => array(
