...
require_login();
redirect('myquestions1.php');


// $PAGE->set_context(context_system::instance());
// $PAGE->set_heading(get_string('pluginname', 'local_report_teacher'));
// $PAGE->set_title(get_string('pluginname', 'local_report_teacher'));
// $PAGE->set_url(str_replace($CFG->wwwroot, '', $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']));
...
//         //     $OUTPUT->content->text .= "<a href=\"$manageurl\">$managetext</a><br />";
//         // }
//         $output .= "<br />";
//     }
...
//     $OUTPUT->footer = "<a href=\"$url\">$translated</a>$prefhelp";
